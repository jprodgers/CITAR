...
pub static TYPE_INFO: [TypeInfo; 637] = [
    ...
    TypeInfo { name: "CanSpeedupWonderConstruction", placeholder: "Can speed up the construction of a wonder", signature: "Can speed up the construction of a wonder", support: Some(&Support { role: Role::Action, params: &[], fields: &[], gain: false, stages: &[Stage::Actions, Stage::GreatPeople], reason: None }) },
    ...
    TypeInfo { name: "NaturalWonderSmallerLandmass", placeholder: "Must not be on [] largest landmasses", signature: "Must not be on [amount] largest landmasses", support: Some(&Support { role: Role::Mapgen, params: &[ParamKind::NonNegativeAmount], fields: &["count"], gain: false, stages: &[Stage::Mapgen], reason: None }) },
    TypeInfo { name: "NaturalWonderLargerLandmass", placeholder: "Must be on [] largest landmasses", signature: "Must be on [amount] largest landmasses", support: Some(&Support { role: Role::Mapgen, params: &[ParamKind::NonNegativeAmount], fields: &["count"], gain: false, stages: &[Stage::Mapgen], reason: None }) },
...
impl UniqueData {
    ...
    pub(crate) fn build(ty: UniqueType, cx: &mut ParamCx<'_, '_>) -> Result<Self, ParamError> {
        Ok(match ty {
            ...
            UniqueType::NaturalWonderSmallerLandmass => Self::NaturalWonderSmallerLandmass(p::NaturalWonderSmallerLandmass { count: cx.get(0, ParamKind::NonNegativeAmount)? }),
            UniqueType::NaturalWonderLargerLandmass => Self::NaturalWonderLargerLandmass(p::NaturalWonderLargerLandmass { count: cx.get(0, ParamKind::NonNegativeAmount)? }),
