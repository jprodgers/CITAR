...
//! writer (DESIGN.md 3.2, package 1a-02), and the serde forms the save and the digest share that
//! need no ruleset (`codec`, package 1a-09). It depends on no other module of this crate.
//!
