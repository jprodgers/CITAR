...
//! package 1c-02 `set_unit` and `ready_unit`; package 1c-03 `attack_as` and `capture_civilian`.
//! The others are listed with the package that ports what they need, and are refused as not
//! ported until then.
