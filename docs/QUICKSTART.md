...
If CITAR is not installed yet, [INSTALL.md](INSTALL.md) has every route. The short one:
...
wrong port. [TROUBLESHOOTING.md](TROUBLESHOOTING.md) has the rest.
...
- [PLAYING.md](PLAYING.md) — every screen and shortcut in the browser client
- [AI_PLAYERS.md](AI_PLAYERS.md) — how a model actually takes a turn, and the guard rails for
  weaker ones
- [BENCHMARKS.md](BENCHMARKS.md) — scheduling, scoring, and what the numbers mean
- [SCENARIOS.md](SCENARIOS.md) — testing one decision instead of a whole game
- [server/DEPLOY.md](server/DEPLOY.md) — running this for other people
