...
**Models** come from the [Servers](Servers-costs-and-reports#servers) page — a server, a model on it, and a load
...
- **One game is one sample.** Map luck is enormous in Civ. The model comparison in a
  [report](Servers-costs-and-reports) gives 95% confidence intervals and flags small samples for this reason.
...
*This page is generated from [`docs/BENCHMARKS.md`](https://github.com/jprodgers/CITAR/blob/main/docs/BENCHMARKS.md) and any edit made here will be overwritten. Corrections are welcome as a pull request.*
