...
[docker-compose.yml](https://github.com/jprodgers/CITAR/blob/main/docker-compose.yml) — see [server/DEPLOY.md](Deploying-a-server).
...
Full walkthrough, including what to do when you have an nginx already: [server/DEPLOY.md](Deploying-a-server).
...
`citar admin add-server --name "your machine"`. See [server/WORKERS.md](Workers).
...
*This page is generated from [`docs/INSTALL.md`](https://github.com/jprodgers/CITAR/blob/main/docs/INSTALL.md) and any edit made here will be overwritten. Corrections are welcome as a pull request.*
