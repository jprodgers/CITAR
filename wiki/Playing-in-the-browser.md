...
[BENCHMARKS.md](Benchmarks#what-the-metrics-mean) explains what each number is for.
...
[server/DEPLOY.md](Deploying-a-server).


---

*This page is generated from [`docs/PLAYING.md`](https://github.com/jprodgers/CITAR/blob/main/docs/PLAYING.md) and any edit made here will be overwritten. Corrections are welcome as a pull request.*
