# Frozen copy of citar/bots/basic.py made by citar.lab on 2026-09-18 12:13
...
DEFAULT_PARAMS: dict = {
    ...
    "policy_order_peaceful": None, "policy_order_aggressive": None,    # None = POLICY_ORDER
    ...
    "siege_city_pref": 1.0,       # attack-value multiplier for the besieged city
    "siege_move_first": False,    # ranged units in a siege move into range/sight of the city before shooting
