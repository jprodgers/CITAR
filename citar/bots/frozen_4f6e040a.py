# Frozen copy of citar/bots/basic.py made by citar.lab on 2026-09-22 08:34
...
PARAM_GROUPS: list[tuple[str, str, list[dict]]] = [
    ...
    ("Building value", "What cities build. UnCiv mode values every option and builds the best value per remaining "
     ...
     "building added and weighting the difference.", [
        ...
        _n("u_carryover_share", 0.5, "Food carry-over", "Granary-style food kept on growth: value share of the food "
           "saved.", 0, 2),
        _n("u_gpp", 0.5, "Great person points", "Per great person point a building adds.", 0, 5),
        ...
        _n("u_wonder_bonus", 4.0, "Wonder bonus", "Flat value added to a world wonder.", 0, 50),
        _n("u_national_wonder_share", 0.5, "National wonder share", "Share of the wonder bonus a national wonder "
           "gets.", 0, 1),
        _b("u_wonder_gate", True, "Gate wonders", "UnCiv: wonders only in above-average-production cities of an "
        ...
        _n("wonder_gate_pop", 12, "Wonder gate population", "Empire population needed for wonders when gated.",
           0, 100),
        _n("u_victory_building", 20, "Victory building", "Value of a building that wins the game (e.g. Utopia).",
           0, 200),
    ]),
    ...
    ("Cities", "Citizens, focus and growth.", [
        ...
        _n("bv_cache_turns", 5, "Reuse building values for", "Turns a city's building values are reused while it "
    ...
    ("War", "When to start a war, how to gather, when to advance.", [
        ...
        _b("prep_gather", False, "Gather before declaring", "Assemble the field army at a rally point before "
